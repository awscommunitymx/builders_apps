...
const handlerFunction: AppSyncResolverHandler<MutationViewProfileArgs, User | null> = async (
  event
) => {
...
export const handler = middy(handlerFunction).use(captureLambdaHandler(tracer));
